...
class CreateDocumentOrderItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('document_order_items', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('document_order_items');
    }
}
