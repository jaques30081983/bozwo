...
class CreateSubprojectVehiclesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('subproject_vehicles', function (Blueprint $table) {
        	$table->increments('id');
    ...
    {
        Schema::dropIfExists('subproject_vehicles');
    }
}
